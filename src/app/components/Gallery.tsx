...
export function Gallery() {
  ...
  const featuredArtworks = [
    {
      id: 'featured-1',
      title: 'Crimson Fractures',
      imageUrl: '/api/art/art_01_crimson_fractures.png',
      artist: 'Aurelius',
      likes: 234,
      verified: true,
    },
    {
      id: 'featured-2',
      title: 'Crystal Void',
      imageUrl: '/api/art/art_02_crystal_void.png',
      artist: 'Celeste',
      likes: 189,
      verified: true,
    },
    {
      id: 'featured-3',
      title: 'Blue Horizon',
      imageUrl: '/api/art/art_05_blue_horizon.png',
      artist: 'Maren',
      likes: 167,
      verified: false,
    },
    {
      id: 'featured-4',
      title: 'Echo Chamber',
      imageUrl: '/api/art/art_10_echo_chamber.png',
      artist: 'Yuki',
      likes: 312,
      verified: true,
    },
